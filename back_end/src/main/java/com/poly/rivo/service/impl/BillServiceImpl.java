...
import com.poly.rivo.entity.*;
import com.poly.rivo.infrastructure.common.PhanTrang;
import com.poly.rivo.infrastructure.common.ResponseObject;
import com.poly.rivo.infrastructure.constant.*;
import com.poly.rivo.infrastructure.converter.BillConvert;
...
import com.poly.rivo.infrastructure.session.ShoseSession;
import com.poly.rivo.repository.*;
import com.poly.rivo.service.BillService;
import com.poly.rivo.util.GHNService;
import com.poly.rivo.util.MailUtils;
...
//                    billHistoryRepository.save(historyPaid);
        ...
        if (savedBill.getCustomer() != null && savedBill.getCustomer().getEmail() != null) {
            String emailSubject = "Thông tin hóa đơn - Website bán áo phông Rivo";
